                                        ...
                                        <div class="pt-3 sm:pt-5 lg:pt-0">
                                            ...
                                            <p class="mt-4 text-sm/relaxed">
                                                ...
                                                <ul>
                                                    @if ($art)
                                                        @foreach($art as $elem)
                                                            <li>{{$elem->name}} - {{$elem->price}} - <a href="{{route('article.show',$elem->id)}}">show</a> - <a href="{{route('article.edit',$elem->id)}}">edit</a> </li>
                                                        @endforeach
                                                    @endif
                                                </ul>
                                    ...
                                    <div id="docs-card-content" class="flex items-start gap-6 lg:flex-col">
                                        ...
                                        <div class="pt-3 sm:pt-5 lg:pt-0">
                                            ...
                                            <p class="mt-4 text-sm/relaxed">
                                                ...
                                                <a href="/user/chart">grafico con chart.js</a>
                        ...
                        >
                                ...
                                <div id="docs-card-content" class="flex items-start gap-6 lg:flex-col">
                                    ...
                                    <div class="pt-3 sm:pt-5 lg:pt-0">
                                        ...
                                        <p class="mt-4 text-sm/relaxed">
                                            ...
                                            es.: <pre>curl http://localhost:8000/api/user    -H "Accept: application/json"   -H "Authorization: Bearer aaaaaaaaaaAAAAAAAAAAAAAA222222222222244444444444"</pre>

                                            risposta es.: <pre>{"id":1,"name":"user","email":"user@email.it","email_verified_at":null,"current_team_id":null,"profile_photo_path":null,"created_at":"2024-10-14T08:01:49.000000Z","updated_at":"2024-10-14T08:01:49.000000Z","two_factor_confirmed_at":null,"profile_photo_url":"https:\/\/ui-avatars.com\/api\/?name=m&color=7F9CF5&background=EBF4FF"}</pre>
                            ...
                            >
                                ...
                                <div class="pt-3 sm:pt-5">
                                    <h2 class="text-xl font-semibold text-black">Frasi su Chuck Norris prelevati da Server esterno</h2>

                                    <p class="mt-4 text-sm/relaxed">

                                        Chuck Norris: <ul>  @foreach ($val as $v)
                                                        <li>{{$v->values}} </li>
                                                        @endforeach
                                                        </ul>
                                    </p>
